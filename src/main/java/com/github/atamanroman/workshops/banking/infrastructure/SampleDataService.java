...
public class SampleDataService {
  ...
  public void init() {
    ...
    Transactional.run(em -> {
          try {
            Account acc1 = accountRepository.createAccount("DE1234567890", "Roman", "EUR", 1000, em);
            ...
            accountRepository.saveAccount(acc1, em);
            Account acc2 = accountRepository.createAccount("DE1234567891", "Andi", "EUR", 2000, em);
            ...
            accountRepository.saveAccount(acc2, em);
            Account acc3 = accountRepository.createAccount("DE1234567892", "Nadja", "EUR", 3000, em);
            ...
            accountRepository.saveAccount(acc3, em);
          } catch (Exception e) {
